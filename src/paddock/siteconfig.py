...
def template(name: str) -> str:
    ...
    return (
        ...
        "#\n"
        "# This file is yours and is always applied. A fragment a project\n"
        "# ships is not: it waits until someone trusts it, so it should only\n"
        "# carry directives the site is correct without. Anything an\n"
        "# application requires belongs in paddock.yml, where it can travel\n"
        "# without waiting — an upload limit is `client_max_body_size: 512m`\n"
        "# there.\n"
        "\n"
